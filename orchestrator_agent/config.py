...
AVAILABLE_MODELS = {
    ...
    "groq": ["openai/gpt-oss-20b", "openai/gpt-oss-120b", "llama-3.1-8b-instant", "llama-3.3-70b-versatile"],
...
SIMPLE_FALLBACK_CHAIN = [("groq", "openai/gpt-oss-120b"), ("gemini", "gemini-2.5-flash"), ("ollama", "gemma3:1b")]
