...
class TestLangfuseIntegration(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_langfuse_tracing_disabled_by_default(self, mock_prep_state, mock_get_env):
        ...
        config = {
            "configurable": {"thread_id": "test_thread_no_lf"},
            "metadata": {},
            "tags": []
        }
        mock_prep_state.return_value = (None, mock_graph, config, None, [], {"provider": "openai", "model": "gpt-4o-mini", "chatbot_name": "Jarvis", "tone": "friendly"})
